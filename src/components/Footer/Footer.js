        ...
        <div className="footer-container">
            ...
            <footer className="footer-wrapper">
                ...
                <div className="footer-content">
                    ...
                    <div className="footer-social-media-icons col-3 text-end">
                        <a href="https://www.linkedin.com/in/francielle-abreu" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="20" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16">
                        ...
                        <a href="https://github.com/francielleabreu" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="20" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
                        ...
                        <a href="https://www.behance.net/francielleabreu1" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="20" fill="currentColor" className="bi bi-behance" viewBox="0 0 16 16">
